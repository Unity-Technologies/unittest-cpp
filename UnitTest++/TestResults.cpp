...
void TestResults::OnTestReportPropery(TestDetails const& test, const char* propName, const TestProperty& propValue)
{
	if (m_testReporter)
		m_testReporter->ReportTestProperty(test, propName, propValue);
}
